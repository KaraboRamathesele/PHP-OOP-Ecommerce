<div class="product-container">
    ...
    <div class="add-product">
        <button class="btn add-product"><a href="product/create">Add Product</a> </button>
    ...
    <table>
        ...
        <?php while ($product = $products->fetch_object()) : ?>
            <tr>
                ...
                <td><?= $product->stock; ?></td>
                <td>
                    <a href="product/delete&id=<?= $product->id; ?>"><i class="trash-icon fas fa-trash"></i></a>
                    <a href="product/edit&id=<?= $product->id; ?>"><i class="edit-icon fas fa-edit"></i></a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
