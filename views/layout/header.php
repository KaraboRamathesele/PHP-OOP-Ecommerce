...
<head>
    ...
    <script type="text/javascript" src="client/index.js" defer></script>
            ...
            <header class="header">
                <div class="main-header">
                    <div class="ecommerce-menu">
                        <div class="logo">
                            <h2><a href="">Karabo's </a></h2>
                        </div>
                        <div class="menu-items">
                            <?php $categories = Utils::showCategories();
                            while ($category = $categories->fetch_object()) : ?>
                                <p><a href="category/display&id=<?= $category->id; ?>"><?= $category->name ?></a></p>
                            <?php endwhile; ?>
                        </div>
                    </div>
                    <div class="user-menu">
                            ...
                            <div class="profile-hover-menu hidden">
                                <ul>
                                    <?php if (isset($_SESSION['admin'])) : ?>
                                        <li><a href="category/index">Manage Categories</a> </li>
