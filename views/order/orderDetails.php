...
<?php if (isset($_SESSION['admin'])) : ?>
    ...
    <form style="margin-bottom: 20px;" class="table-align" action="order/status" method="POST">
...
<div class="order-details-container" style="margin-bottom: 50px;">
    ...
    <table>
        ...
        <tr>
            ...
            <td>ZAR<?= $lastOrder->total_price; ?></td>
    ...
    <table>
        ...
        <?php while ($item = $products->fetch_object()) : ?>
            <tr>
                ...
                <td>
                    <a style="color: blue" href="product/singleProduct&id=<?= $item->id ?>"><?= $item->name; ?></a>
                </td>
                <td>
                    $<?= $item->price ?>
                </td>
